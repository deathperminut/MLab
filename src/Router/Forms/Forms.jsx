                                        ...
                                        <table className='table table-sm table-striped table-no-border- align-middle'>
                                          ...
                                          <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <td className='align-middle'>
                                                  <p className='m-0 lh-sm fs-5- ff-monse-regular- fw-normal text-center'>{Answer?.Answer_city['Bajo'] == 0 ?  '0%' :  (parseInt(Answer?.Answer_city['Bajo']) / parseInt(Answer?.Answer_city['cantidad registros'])*100).toFixed(1).toString()+'%'}</p>
                                                </td>
                                                <td className='align-middle'>
                                                  <p className='m-0 lh-sm fs-5- ff-monse-regular- fw-normal text-center'>{Answer?.Answer_city['Mod. bajo'] == 0 ?  '0%' :  (parseInt(Answer?.Answer_city['Mod. bajo']) / parseInt(Answer?.Answer_city['cantidad registros'])*100).toFixed(1).toString()+'%'}</p>
                                                </td>
                                                <td className='align-middle'>
                                                  <p className='m-0 lh-sm fs-5- ff-monse-regular- fw-normal text-center'>{Answer?.Answer_city['Medio'] == 0 ?  '0%' :  (parseInt(Answer?.Answer_city['Medio']) / parseInt(Answer?.Answer_city['cantidad registros'])*100).toFixed(1).toString()+'%'}</p>
                                                </td>
                                                <td className='align-middle'>
                                                  <p className='m-0 lh-sm fs-5- ff-monse-regular- fw-normal text-center'>{Answer?.Answer_city['Mod. alto'] == 0 ?  '0%' :  (parseInt(Answer?.Answer_city['Mod. alto']) / parseInt(Answer?.Answer_city['cantidad registros'])*100).toFixed(1).toString()+'%'}</p>
                                                </td>
                                                <td className='align-middle'>
                                                  <p className='m-0 lh-sm fs-5- ff-monse-regular- fw-normal text-center'>{Answer?.Answer_city['Alto'] == 0 ?  '0%' :  (parseInt(Answer?.Answer_city['Alto']) / parseInt(Answer?.Answer_city['cantidad registros'])*100).toFixed(1).toString()+'%'}</p>
                                                </td>
                                              </tr>
